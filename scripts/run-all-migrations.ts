...
async function run() {
  // Let's run notifications first, then remaining systems
  await runMigration("20260601160000_create_notifications.sql");
  await runMigration("20260601170000_remaining_systems.sql");
