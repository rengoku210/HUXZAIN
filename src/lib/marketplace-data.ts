...
// featuredListings removed — Featured listings are paid-only and served from the DB.
// See listing_boosts table (boost_type = 'homepage_featured' | 'category_featured').
// No hardcoded or dummy featured data is allowed per platform spec.
