...
const rolePerms: Record<Role, Permission[]> = {
  ...
  payment_reviewer: ["payment:verify", "order:view_any", "payout:approve"],
  dispute_manager: ["dispute:resolve", "report:view", "order:view_any"],
  support_agent: ["report:view", "order:view_any"],
  verification_officer: ["payment:verify"],
