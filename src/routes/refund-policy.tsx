  ...
  head: () => ({
    meta: [
      { title: "Refund Policy — HUXZAIN" },
      {
        name: "description",
        content:
          "HUXZAIN's Refund Policy. Learn about our 30-Day Buyer Guarantee, eligible disputes, the refund process, and exclusions.",
      },
      ...
      <main className="flex-1 container-page py-14">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto text-sm leading-relaxed">
            At HUXZAIN, your peace of mind is our priority. Our buyer protection policy ensures
            every transaction is safe and every legitimate concern is heard.
          </p>
        ...
        <div className="mb-10 relative overflow-hidden rounded-2xl border border-gold/30 bg-gradient-to-br from-surface-elevated via-surface to-background p-8">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(600px 300px at 80% 50%, oklch(0.82 0.13 82 / 0.12), transparent 60%)",
            }}
          />
          <div className="relative flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-sm text-muted-foreground max-w-xl leading-relaxed">
                Every purchase on HUXZAIN is protected by our 30-Day Buyer Guarantee. Your payment
                is held securely in escrow and only released to the seller after you confirm
                satisfaction — or after the 30-day window closes without a dispute.
              </p>
            </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-3xl font-display font-bold text-gold/20">
                      {step.step}
                    </span>
                  </div>
                  <div>
          ...
          <div className="rounded-2xl border border-border bg-surface/40 p-7">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {eligibilityItems.map((item, i) => (
                <div
                  key={i}
                  className={`flex items-start gap-3 p-3 rounded-xl ${item.ok ? "bg-green-950/30 border border-green-800/30" : "bg-red-950/30 border border-red-900/30"}`}
                >
                  {item.ok ? (
        ...
        <section className="mb-10 rounded-2xl border border-border bg-surface/40 p-7">
          ...
          <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
            <p>
              <span className="text-foreground font-medium">Platform Commission:</span> HUXZAIN's
              service fee is non-refundable in cases where the seller has fulfilled the agreed-upon
              order, regardless of whether a subsequent dispute is opened.
            </p>
            <p>
              <span className="text-foreground font-medium">Custom Orders:</span> Refunds for
              bespoke or custom-made digital products may be subject to additional review. Sellers
              who have invested significant time in a custom project may receive partial
              compensation even in cases where a refund is granted.
            </p>
            <p>
              <span className="text-foreground font-medium">Subscription Services:</span> Ongoing
              subscription-based services are refunded on a pro-rata basis for the unused period,
              provided a dispute is raised within the first 7 days of the billing cycle.
            </p>
            <p>
              <span className="text-foreground font-medium">Chargeback Policy:</span> Initiating a
              chargeback with your bank or card provider while a HUXZAIN dispute is in progress may
              result in account suspension. Please allow our Resolution Team to handle disputes
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Go to your Orders page and click "Open Dispute" on the relevant order.
              </p>
            </div>
          </div>
          <Link
