  ...
  head: () => ({
    meta: [
      { title: "How It Works — HUXZAIN" },
      {
        name: "description",
        content:
          "Learn how HUXZAIN works — browse listings, purchase securely, verify payment, and receive your digital product.",
      },
    ],
  }),
...
const STEPS = [
  {
    ...
    description:
      "Explore thousands of digital products and services from verified sellers. Use filters, categories, and search to find exactly what you need.",
  ...
  },
  {
    ...
    description:
      "Click 'Buy Now' and proceed to our secure checkout. Your payment is held in escrow until you confirm delivery — you're always protected.",
  ...
  },
  {
    ...
    description:
      "Submit your payment proof (screenshot + Transaction ID). Our team verifies it within 24 hours. You'll receive a confirmation notification.",
  ...
  },
  {
    ...
    description:
      "Once payment is verified, the seller delivers your product or service. Review and confirm — funds are released to the seller only after your approval.",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground mt-4 max-w-xl mx-auto leading-relaxed">
              A simple, transparent, and secure process that protects both buyers and sellers at
              every step.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Join thousands of buyers and sellers on HUXZAIN today.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                to="/"
                className="h-12 px-8 rounded-xl bg-gold text-primary-foreground text-sm font-semibold hover:brightness-110 inline-flex items-center justify-center gap-2 transition-all"
              >
                Browse Marketplace <ArrowRight className="size-4" />
              </Link>
              <Link
                to="/seller-panel"
                className="h-12 px-8 rounded-xl border border-border text-sm font-medium hover:border-gold/40 inline-flex items-center justify-center transition-colors"
              >
                Become a Seller
              </Link>
            </div>
