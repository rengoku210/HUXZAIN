...
- Name: seller-subscription.spec.ts >> Seller Subscription UPI manual payment flow E2E >> 3. complete flow & success GPay animation
- Location: e2e\seller-subscription.spec.ts:127:3
...
Call log:
  - waiting for locator('button:has-text("I\'ve Paid / Confirm Payment")')
